...
class FinancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create finance" do
    assert_difference("Finance.count") do
      post finances_url, params: { finance: { balance: @finance.balance, child_id: @finance.child_id, expenses: @finance.expenses } }
    end
  ...
  test "should update finance" do
    patch finance_url(@finance), params: { finance: { balance: @finance.balance, child_id: @finance.child_id, expenses: @finance.expenses } }
