...
class ChildrenControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create child" do
    assert_difference("Child.count") do
      post children_url, params: { child: { user_id: @child.user_id, username: @child.username } }
    end
  ...
  test "should update child" do
    patch child_url(@child), params: { child: { user_id: @child.user_id, username: @child.username } }
